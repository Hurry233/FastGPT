...
description: GPTW Agent OpenAPI Introduction
---
...
- [China Mainland API Documentation](https://gptw.top/openapi)
- [International API Documentation](https://gptw.top/openapi)

## Usage Guide

GPTW Agent OpenAPI lets you authenticate with an API Key to access GPTW Agent services and resources -- such as calling app chat endpoints, uploading knowledge base data, search testing, and more. For compatibility and security reasons, not all endpoints support API Key access.
...
GPTW Agent has **2 types** of API Keys: a global key (cannot directly call app chat) and an app-specific key that includes an AppId (can directly call app chat).
