---
title: Dataset API
description: GPTW Agent OpenAPI Dataset API
---
...
--header 'Content-Type: application/json' \
--data-raw '{
    "link":"https://gptw.top/guide/getting-started/quick-start",
    "datasetId":"6593e137231a2be9c5603ba7",
    "parentId": null,
  ...
  "data": {
    "list": [
      ...
      },
      {
        ...
        "tmbId": "65422be6aa44b7da77729ec9",
        "type": "link",
        "name": "快速上手 | GPTW Agent",
        "rawLink": "https://gptw.top/guide/getting-started/quick-start",
