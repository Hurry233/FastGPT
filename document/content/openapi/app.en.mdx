...
description: GPTW Agent OpenAPI Application Interface
---
...
<Tabs items={["Request Example","Response Example","Parameters"]}>
  ...
  ```bash
 curl --location --request GET 'https://gptw.top/api/proApi/core/app/logs/getTotalData?appId=68c46a70d950e8850ae564ba' \
...
<Tab value="Request Example">
  ...
  ```bash
curl --location --request POST 'https://gptw.top/api/proApi/core/app/logs/getChartData' \
--header 'Authorization: Bearer apikey' \
