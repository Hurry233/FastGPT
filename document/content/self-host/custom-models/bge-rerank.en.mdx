...
description: Integrating bge-rerank reranking model with GPTW Agent
---
...
1. [https://gptw.top](https://gptw.top)
2. [https://gptw.top](https://gptw.top)
3. [https://gptw.top](https://gptw.top)
...
1. Open the GPTW Agent model configuration and add a new reranking model.
...
The custom request token in GPTW Agent does not match the ACCESS_TOKEN environment variable.
