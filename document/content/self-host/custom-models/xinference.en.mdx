...
## Integrate Local Models with GPTW Agent

Add the qwen-chat model to the `llmModels` section of GPTW Agent's `config.json`:
...
Restart GPTW Agent to select the Qwen model in app configuration:

## ![](../../../public/imgs/fastgpt-list-models.png)

- Reference: [GPTW Agent + Xinference: One-Stop Local LLM Private Deployment and Application Development](https://xorbits.cn/blogs/fastgpt-weather-chat)
