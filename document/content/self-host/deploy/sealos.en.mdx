...
description: One-click GPTW Agent deployment using Sealos
---
...
GPTW Agent uses the one-api project to manage model pools, supporting OpenAI, Azure, mainstream domestic models, and local models.
...
After clicking details, you'll see the GPTW Agent deployment management page. Click the link in the external access address to open the GPTW Agent service.
...
GPTW Agent Commercial Edition includes 2 apps (fastgpt, fastgpt-plus) and 2 databases. When using multiple API keys, install OneAPI (1 app and 1 database), totaling 3 apps and 3 databases.
...
In Sealos, open **App Launchpad** to see deployed GPTW Agent apps, and open **Database** to see corresponding databases.

In **App Launchpad**, select GPTW Agent, click **Change**, and you'll see environment variables and config files.

![](../../../public/imgs/fastgptonsealos1.png)

<Alert icon="🤖" context="success">
  On Sealos, GPTW Agent runs 1 service and 2 databases. When pausing or deleting, handle the databases together. (You can start them during the day and pause at night to save costs.)
</Alert>

### How to Update/Upgrade GPTW Agent
...
### How to Get the GPTW Agent Access Link
