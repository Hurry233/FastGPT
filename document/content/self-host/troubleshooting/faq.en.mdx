...
description: GPTW Agent Self-Hosting General Troubleshooting
---
...
Or GPTW Agent cannot request OneAPI (not in the same network).

---

### How to change the root password

Modify the `DEFAULT_ROOT_PSW` environment variable, and then restart GPTW Agent.
