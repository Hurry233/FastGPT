...
description: GPTW Agent usage notes
---

# Troubleshooting Notes

If you encounter issues while using GPTW Agent, follow the steps below to troubleshoot and resolve them.
...
- **Check version**: View the current running version on the GPTW Agent homepage or in the admin panel.
