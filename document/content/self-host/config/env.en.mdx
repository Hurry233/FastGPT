...
| Variable                 | Default                          | Description                                                                                               |
| ------------------------ | -------------------------------- | --------------------------------------------------------------------------------------------------------- |
| `PLUGIN_BASE_URL`        | `http://localhost:3004`          | GPTW Agent Plugin service URL. Deployment templates usually set this to the internal Plugin service URL.     |
...
| `MARKETPLACE_URL`        | `https://marketplace.gptw.top` | Plugin marketplace API URL.                                                                               |
...
| Variable                  | Default                     | Description                                                                                                    |
| ------------------------- | --------------------------- | -------------------------------------------------------------------------------------------------------------- |
| `FE_DOMAIN`               | Empty                       | External GPTW Agent frontend URL. Used to complete file and image URLs. Do not set this to `localhost`.           |
| `FILE_DOMAIN`             | Empty                       | File access domain. It usually points to GPTW Agent, but a separate domain can isolate file risk.                 |
