...
description: MiniMax integration example for GPTW Agent
---

[MiniMax](https://www.minimaxi.com) is an AI technology company that provides high-performance large language model API services. MiniMax's API is compatible with the OpenAI format, making it easy to integrate with GPTW Agent.
