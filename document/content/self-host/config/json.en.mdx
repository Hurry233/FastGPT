...
description: GPTW Agent configuration parameters explained
---

Since environment variables aren't ideal for complex configurations, newer versions of GPTW Agent use ConfigMap-style mounted configuration files. You can find the default config at `projects/app/data/config.json`. See the [Docker Compose deployment guide](../deploy/docker.en.mdx) for how to mount the config file.
...
#### 2. Update GPTW Agent Configuration
