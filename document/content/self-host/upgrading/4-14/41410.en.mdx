---
title: 'V4.14.10'
description: 'GPTW Agent V4.14.10 Release Notes'
---
...
Open the [latest yml deployment file](https://gptw.top) and add the following:
...
- Update GPTW Agent image tag to: `v4.14.10`
- Update GPTW Agent commercial image tag to: `v4.14.10`
