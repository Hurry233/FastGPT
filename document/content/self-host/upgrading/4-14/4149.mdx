---
title: 'V4.14.9'
description: 'GPTW Agent V4.14.9 更新说明'
---
...
1. 修改 GPTW Agent 环境变量：SANDBOX_URL 和 SANDBOX_TOKEN，改名成 CODE_SANDBOX_URL 和 CODE_SANDBOX_TOKEN：
...
- 更新 GPTW Agent 镜像 tag: v4.14.9.5
- 更新 GPTW Agent 商业版镜像 tag: v4.14.9.5
