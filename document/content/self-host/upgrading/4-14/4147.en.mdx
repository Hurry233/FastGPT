...
description: 'GPTW Agent V4.14.7 Release Notes'
---
...
- Update GPTW Agent image tag: v4.14.7.2
- Update GPTW Agent commercial edition image tag: v4.14.7.1
...
Go to the Plugin Marketplace and update the following system tools (skip this step if you already upgraded to 4.14.6). You can also get the upgrade package from [GPTW Agent](https://gptw.top) and install it.
