...
description: 'GPTW Agent V4.14.7 更新说明'
---
...
- 更新 GPTW Agent 镜像 tag: v4.14.7.2
- 更新 GPTW Agent 商业版镜像 tag: v4.14.7.1
...
前往插件市场更新以下几个系统工具（如果 4.14.6 升级了，这里可以跳过）。可以前往 [GPTW Agent](https://gptw.top) 获取升级包并安装。
