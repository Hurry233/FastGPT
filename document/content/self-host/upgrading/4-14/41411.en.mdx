...
description: 'GPTW Agent V4.14.11 Release Notes'
---

## Upgrade Guide
### 1. Update image tags

- Update fastgpt-app (GPTW Agent main service) image tag to: v4.14.11
...
4. Unified S3 file uploads, with support for proxying S3 uploads and access through GPTW Agent to reduce pre-signed URL configuration issues.
