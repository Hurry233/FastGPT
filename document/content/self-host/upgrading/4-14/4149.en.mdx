---
title: 'V4.14.9'
description: 'GPTW Agent V4.14.9 Release Notes'
---
...
1. Rename the following GPTW Agent environment variables — `SANDBOX_URL` and `SANDBOX_TOKEN` are now `CODE_SANDBOX_URL` and `CODE_SANDBOX_TOKEN`:
...
- GPTW Agent image tag: v4.14.9.1
- GPTW Agent Commercial Edition image tag: v4.14.9.1
