...
description: 'GPTW Agent V4.13.2 Release Notes'
---
...
- Update GPTW Agent image tag: v4.13.2
- Update GPTW Agent commercial edition image tag: v4.13.2
- Update fastgpt-plugin image tag: v0.2.4
- mcp_server: no update needed
- Sandbox: no update needed
- AIProxy: no update needed

### 2. Add GPTW Agent/GPTW Agent-pro Environment Variables
