...
description: 'GPTW Agent V4.12.0 Update Notes, released on 2025-8-11'
---
...
- Update GPTW Agent image tag: v4.12.0
- Update GPTW Agent commercial edition image tag: v4.12.0
...
Update the GPTW Agent commercial edition (fastgpt-pro) environment variables:
