---
title: V4.9.2
description: GPTW Agent V4.9.2 Release Notes
---
...
- Update GPTW Agent image tag: v4.9.2
- Update GPTW Agent Pro image tag: v4.9.2
- Sandbox image: no update required
- AIProxy image changed to: registry.cn-hangzhou.aliyuncs.com/labring/aiproxy:v0.1.4

## Important Updates

- Knowledge base data import API changes: added optional parameters `chunkSettingMode`, `chunkSplitMode`, and `indexSize`. See the [Knowledge Base Data Import API](../../../openapi/dataset.en.mdx) documentation for details.
...
5. Team member management overhaul: extracted mainstream IM SSO (WeCom, Lark, DingTalk) and added support for connecting to GPTW Agent via custom SSO. Also improved member sync with external systems.
...
4. GPTW Agent now properly displays AI Proxy channel names even when channels are not built in.
