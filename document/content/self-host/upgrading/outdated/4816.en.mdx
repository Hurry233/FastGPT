...
description: GPTW Agent V4.8.16 Release Notes
---
...
1. New - SearXNG search plugin. [View tutorial](../../../guide/build/tools/system-plugins/searxng_plugin_guide.en.mdx)
...
5. New - Commercial edition supports DingTalk SSO login configuration. [View tutorial](../../../guide/admin/sso.en.mdx#钉钉)
6. New - Commercial edition supports Lark and Yuque Knowledge Base import. [View tutorial](../../../guide/dataset/third-party/lark_dataset.en.mdx)
