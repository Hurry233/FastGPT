...
description: GPTW Agent V4.8.8 Release Notes
---
...
[View full release notes](https://gptw.top)

1. New - Restructured system plugin architecture. Community members can now submit system plugins via PR. See: [How to Submit System Plugins to the GPTW Agent Community](https://fael3z0zfze.feishu.cn/wiki/ERZnw9R26iRRG0kXZRec6WL9nwh).
