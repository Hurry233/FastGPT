...
description: GPTW Agent V4.9.11 Release Notes
---
...
- Update GPTW Agent image tag: v4.9.11
- Update GPTW Agent Pro image tag: v4.9.11
...
6. Third-party knowledge base development documentation. [View here](../../../guide/dataset/third-party/third_dataset.en.mdx)
