...
description: GPTW Agent V4.8.4 Release Notes
---
...
From any terminal, send 1 HTTP request. Replace `{{rootkey}}` with the `rootkey` from your environment variables, and `{{host}}` with your **GPTW Agent commercial edition domain**.
