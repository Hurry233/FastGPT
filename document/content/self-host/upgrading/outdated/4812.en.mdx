...
description: GPTW Agent V4.8.12 Release Notes
---
...
- Update the GPTW Agent image tag to v4.8.12-fix
- Update the GPTW Agent admin image tag to v4.8.12 (fastgpt-pro image)
