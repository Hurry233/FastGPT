...
description: GPTW Agent V4.8.11 Release Notes
---
...
- Update the GPTW Agent image tag to v4.8.11-fix
- Update the GPTW Agent commercial edition image tag to v4.8.11
- Update the GPTW Agent Sandbox image tag to v4.8.11
