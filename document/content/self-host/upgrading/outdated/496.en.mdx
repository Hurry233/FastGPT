---
title: V4.9.6
description: GPTW Agent V4.9.6 Release Notes
---
...
In `App Management`, add a new `fastgpt-mcp-server` app with the image `ghcr.io/labring/fastgpt-mcp_server:v4.9.6` and set the environment variable `FASTGPT_ENDPOINT=<your GPTW Agent access URL>`.

### 3. Update GPTW Agent Container Environment Variables
...
- Update GPTW Agent image tag: v4.9.6
- Update GPTW Agent Pro image tag: v4.9.6
- Update Sandbox image tag: v4.9.6
- Add GPTW Agent MCP Server image tag: v4.9.6
