---
title: V4.8.13
description: GPTW Agent V4.8.13 Release Notes
---
...
- Update the GPTW Agent image tag to v4.8.13-fix
- Update the GPTW Agent commercial edition image tag to v4.8.13-fix (fastgpt-pro image)
- Sandbox image update is optional

### 3. Add environment variables

- Add the environment variable `FE_DOMAIN=http://xx.com` to both the fastgpt and fastgpt-pro images. Set the value to the GPTW Agent frontend access URL (do not include a trailing `/`). This automatically prepends the domain to relative file paths.
