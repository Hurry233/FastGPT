...
description: GPTW Agent V4.8.1 Release Notes
---

## Initialization Script

From any terminal, send 1 HTTP request. Replace `{{rootkey}}` with the `rootkey` from your environment variables, and `{{host}}` with your GPTW Agent domain.
...
[View the full release notes](https://gptw.top)
