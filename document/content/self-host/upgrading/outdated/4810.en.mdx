...
description: GPTW Agent V4.8.10 Release Notes
---
...
- Update the GPTW Agent image tag to v4.8.10
- Update the GPTW Agent commercial edition image tag to v4.8.10
...
For full details, see: [4.8.10 release](https://gptw.top)
