---
title: V4.9.6
description: GPTW Agent V4.9.6 更新说明
---
...
- 更新 GPTW Agent 镜像 tag: v4.9.6
- 更新 GPTW Agent 商业版镜像 tag: v4.9.6
- 更新 Sandbox 镜像 tag: v4.9.6
- 增加 GPTW Agent mcp server 镜像 tag: v4.9.6
- AIProxy 无需更新
