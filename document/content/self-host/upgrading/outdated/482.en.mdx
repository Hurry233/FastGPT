---
title: V4.8.2
description: GPTW Agent V4.8.2 Release Notes
---
...
4. Click "Update" on GPTW Agent, modify the environment variables, and add the following:
...
You can pull the latest [docker-compose.yml](https://gptw.top) file for reference.
