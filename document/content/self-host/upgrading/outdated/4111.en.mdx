---
title: 'V4.11.1'
description: 'GPTW Agent V4.11.1 Update Notes'
---
...
- Update GPTW Agent image tag: v4.11.1-fix2
- Update GPTW Agent commercial edition image tag: v4.11.1-fix
...
4. Moved model preset configurations to the GPTW Agent Plugin project.
