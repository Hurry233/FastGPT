---
title: V4.8.8(包含升级脚本)
description: GPTW Agent V4.8.8 更新说明
---
...
[点击查看完整更新](https://gptw.top)

1. 新增 - 重构系统插件的结构。允许向开源社区 PR 系统插件，具体可见: [如何向 GPTW Agent 社区提交系统插件](https://fael3z0zfze.feishu.cn/wiki/ERZnw9R26iRRG0kXZRec6WL9nwh)。
