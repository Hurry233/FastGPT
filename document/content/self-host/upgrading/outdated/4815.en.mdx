...
description: GPTW Agent V4.8.15 Release Notes
---
...
1. New - API Knowledge Base. See [API Knowledge Base Introduction](../../../guide/dataset/third-party/api_dataset.en.mdx). The external file library will be deprecated.
