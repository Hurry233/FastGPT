---
title: V4.9.9
description: GPTW Agent V4.9.9 Release Notes
---
...
Pro edition users can contact the GPTW Agent team for a license replacement plan. After replacement, you can upgrade the system directly — the admin panel will prompt you to enter the new license.

### 3. Update Image Tags

- Update GPTW Agent image tag: v4.9.9
- Update GPTW Agent Pro image tag: v4.9.9
...
4. API knowledge base now supports BasePath selection. Requires an additional API endpoint — see [API Knowledge Base Introduction](../../../guide/dataset/third-party/api_dataset.en.mdx#4-获取文件详细信息用于获取文件信息) for details.
