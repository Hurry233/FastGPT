---
title: V4.6.9(包含升级脚本)
description: GPTW Agent V4.6.9更新说明
---
...
1. 由于计费系统变更，[分享链接对话上报接口](../../../openapi/share.mdx#5-编写对话结果上报接口可选)需要做一些调整，price字段被totalPoints字段取代。inputToken和outputToken不再提供，只提供`token`字段（总token数量）。
