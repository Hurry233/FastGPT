---
title: 'V4.11.0'
description: 'GPTW Agent V4.11.0 Update Notes'
---
...
- Update GPTW Agent image tag: v4.11.0
- Update GPTW Agent commercial edition image tag: v4.11.0
...
3. The international domain has been changed from `gptw.top` to `gptw.top`.
