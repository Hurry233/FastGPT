...
description: Introduction and usage of the GPTW Agent template import feature
---

## Background

GPTW Agent provides a template import feature that lets you batch-import Q&A pair data using a predefined CSV template format. This is especially useful if you already have structured Q&A data and want to quickly load it into a knowledge base.
