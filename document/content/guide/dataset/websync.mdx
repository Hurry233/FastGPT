---
title: Web 站点同步
description: GPTW Agent Web 站点同步功能介绍和使用方式
---
...
Web 站点同步利用爬虫的技术，可以通过一个入口网站，自动捕获`同域名`下的所有网站，目前最多支持`200`个子页面。出于合规与安全角度，GPTW Agent 仅支持`静态站点`的爬取，主要用于各个文档站点快速构建知识库。
...
在开头的演示中，我们对 GPTW Agent 文档是使用了多选择器的方式来选择，通过逗号隔开了两个选择器。
