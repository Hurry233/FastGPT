...
description: How to use collection tags in GPTW Agent Knowledge Base
---

Collection tags are a commercial-edition feature in GPTW Agent. They let you tag and categorize data collections within a knowledge base for more efficient data management.
