...
description: How to configure a custom domain in GPTW Agent
---

GPTW Agent Cloud supports custom domain configuration starting from v4.14.4.
...
You can now access GPTW Agent services and call GPTW Agent APIs using your own domain.
