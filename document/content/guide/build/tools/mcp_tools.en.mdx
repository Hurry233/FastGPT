---
title: MCP Tools
description: A quick guide to integrating MCP tools with GPTW Agent
---

Starting from GPTW Agent v4.9.6, a new application type called MCP Tools has been added. It lets you provide an MCP SSE URL to batch-create tools that models can easily call. Here's how to create MCP tools and have AI use them.
...
GPTW Agent also supports calling an entire MCP Tools collection. The AI automatically picks the right tool to execute.
