...
description: GPTW Agent DingTalk Bot Integration Tutorial
---

Starting from version 4.8.16, GPTW Agent commercial edition supports direct DingTalk bot integration without additional APIs.
...
## 2. Add a Publishing Channel in GPTW Agent

In GPTW Agent, select the app you want to integrate. On the **Publishing Channels** page, create a new DingTalk bot publishing channel.
...
Click the **Bot** capability on the left sidebar, then set the **Message Receiving Mode** at the bottom to **HTTP Mode**, and paste the GPTW Agent callback address you copied earlier as the message receiving address.
