...
description: Access GPTW Agent app via API
---

import { Alert } from '@/components/docs/Alert';

In GPTW Agent, you can create multiple API keys for each app to access the app's API endpoints. Each key can only access one app. For complete endpoint documentation, [see the Chat API reference](../../../openapi/intro.en.mdx).
