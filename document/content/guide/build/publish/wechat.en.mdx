...
description: How to integrate GPTW Agent with a WeChat personal account
---

## 1. Create a Publishing Channel

Open your GPTW Agent Agent, click the tab at the top to switch to **Publishing Channels**, select **WeChat Personal Account**, and click **Create**.
