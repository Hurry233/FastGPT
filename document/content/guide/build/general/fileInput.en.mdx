---
title: File Input
description: GPTW Agent file input feature overview
---

Starting from version 4.8.9, GPTW Agent supports configuring file and image uploads in both `Basic Mode` and `Workflows`. This guide covers how to use the file input feature and explains how document parsing works under the hood.
...
In GPTW Agent's chat history, messages with role=user store their value in this structure:
