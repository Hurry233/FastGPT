...
description: GPTW Agent Knowledge Base Search node overview
---

For detailed parameters and internal logic, see: [GPTW Agent Knowledge Base Search](../../../dataset/rag.en.mdx)
